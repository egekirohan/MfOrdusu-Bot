...
message.guild.channels.create('📌・diğer-sunucular', {type: 'text'}).then(c => c.setParent(parent.id));
});
...
message.guild.channels.create('●▬▬▬▬๑「🧑」๑▬▬▬▬●', {type: 'category'}).then(parent => {
message.guild.channels.create('🧑・man-foto', {type: 'text'}).then(c => c.setParent(parent.id));
message.guild.channels.create('🧑・man-gif', {type: 'text'}).then(c => c.setParent(parent.id));
message.guild.channels.create('🧑・man-vip', {type: 'text'}).then(c => c.setParent(parent.id));
});

message.guild.channels.create('●▬▬▬▬๑「👩」๑▬▬▬▬●', {type: 'category'}).then(parent => {
message.guild.channels.create('👩・women-foto', {type: 'text'}).then(c => c.setParent(parent.id));
message.guild.channels.create('👩・women-gif', {type: 'text'}).then(c => c.setParent(parent.id));
message.guild.channels.create('👩・women-vip', {type: 'text'}).then(c => c.setParent(parent.id));
});

message.guild.channels.create('●▬▬▬▬๑「🐱」๑▬▬▬▬●', {type: 'category'}).then(parent => {
message.guild.channels.create('🐱・animal-foto', {type: 'text'}).then(c => c.setParent(parent.id));
message.guild.channels.create('🐱・animal-gif', {type: 'text'}).then(c => c.setParent(parent.id));
message.guild.channels.create('🐱・animal-vip', {type: 'text'}).then(c => c.setParent(parent.id));
});

message.guild.channels.create('●▬▬▬▬๑「💞」๑▬▬▬▬●', {type: 'category'}).then(parent => {
message.guild.channels.create('💞・couple-foto', {type: 'text'}).then(c => c.setParent(parent.id));
message.guild.channels.create('💞・couple-gif', {type: 'text'}).then(c => c.setParent(parent.id));
message.guild.channels.create('💞・couple-vip', {type: 'text'}).then(c => c.setParent(parent.id));
});

message.guild.channels.create('●▬▬▬▬๑「⭐」๑▬▬▬▬●', {type: 'category'}).then(parent => {
message.guild.channels.create('⭐・famous-foto', {type: 'text'}).then(c => c.setParent(parent.id));
message.guild.channels.create('⭐・famous-gif', {type: 'text'}).then(c => c.setParent(parent.id));
message.guild.channels.create('⭐・famous-vip', {type: 'text'}).then(c => c.setParent(parent.id));
});
});
...
exports.conf = {
  enabled: true,
  guildOnly: true,
  aliases: ['gifsunucukur', 'gifsunucusukur', 'gif-sunucu', 'gifsunucusu'],
  permLevel: 0
}
