...
message.guild.channels.create('●▬▬▬▬๑「🔊」๑▬▬▬▬●', {type: 'category'}).then(parent => {
message.guild.channels.create('🔊 ・ Özel¹ ', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(1));
message.guild.channels.create('🔊 ・ Özel² ', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(2));
message.guild.channels.create('🔊 ・ Özel³ ', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(3));
message.guild.channels.create('🔊 ・ Özel⁴ ', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(4));
message.guild.channels.create('🔊 ・ Özel⁵ ', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(5));
message.guild.channels.create('🔊 ・ Özel⁶ ', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(6));
message.guild.channels.create('🔊 ・ Özel⁷ ', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(7));
message.guild.channels.create('🔊 ・ Özel⁸ ', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(8));
message.guild.channels.create('🔈 ・ AFK⁰ ', {type: 'voice'}).then(a => a.setParent(parent.id) && a.setUserLimit(50));
});
...
exports.conf = {
  enabled: true,
  guildOnly: true,
  aliases: ['oyunsunucukur', 'oyunsunucusukur', 'oyun-sunucu', 'oyunsunucusu', 'o-s', 'os'],
  permLevel: 0
}

exports.help = {
  name: 'oyun-sunucu-kur'
};